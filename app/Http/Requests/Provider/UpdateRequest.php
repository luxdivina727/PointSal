...
class UpdateRequest extends FormRequest
{
    ...
    public function rules()
    {
        return [
            ...
            'providersNit'=>'required|integer|max:10|unique:providers,providersNit,'.$this->route('provider')->id,
            'providersEmail'=>'required|string|max:150|unique:providers,providersEmail,'.$this->route('provider')->id,
            'providersPhone'=>'required|integer|max:10|unique:providers,providersPhone,'.$this->route('provider')->id,
        ];
    }
